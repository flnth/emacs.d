...
(custom-set-faces
 ...
 '(lsp-face-highlight-read ((t (:foreground "DarkSeaGreen1" :underline "gray30"))))
 '(lsp-face-highlight-textual ((t (:foreground "light blue" :underline "gray40"))))
 '(lsp-face-highlight-write ((t (:foreground "RosyBrown1" :underline "Gray30"))))
 ...
 '(mode-line ((t (:background "#161616" :foreground "wheat4" :box nil :underline nil))))
 ...
 '(mode-line-inactive ((t (:background "#161616" :foreground "AntiqueWhite4" :box nil))))
